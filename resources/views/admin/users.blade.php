...
@section('content')
    ...
    <div class="container bg-light p-3 rounded">
        ...
        <div class="row">
            <div class="col-6">
                <h2 class="h1">User's Management</h2>
            </div>
            <div class="col-6">
                <div class="btn-group float-right">
                    <a href="{{route('admin.add_user', ['token' => \Illuminate\Support\Str::random(35)])}}" class="btn btn-default border"><i class="fa fa-plus"></i></a>
                </div>
            </div>
        </div>
            ...
            @foreach($data as $users)
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <button class="btn btn-outline-dark p-1" onclick="setAdmin('{{$users->user_id}}','{{csrf_token()}}')">Set as Admin</button>
                        @endif
